    ...
    <div class="container">
        ...
        <div class="card mt-5">
            <div class="card-body bg-info">
                <div class='mx-lg-3'>
                    <form action="td07_e3_f3_hidden.php" method="GET">
                        ...
                        <input type="hidden" name="nameOrg" value="<?php echo htmlspecialchars($nameOrg); ?>">
                        <input type="hidden" name="adressOrg" value="<?php echo htmlspecialchars($adressOrg); ?>">
                        <input type="hidden" name="creationDateOrg" value="<?php echo htmlspecialchars($creationDateOrg); ?>">
