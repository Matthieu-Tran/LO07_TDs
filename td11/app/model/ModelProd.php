...
class ModelProd
{
    private $id, $nom, $prenom, $region, $nb_producteurs;
    ...
    public function getNbProducteurs()
    {
        return $this->nb_producteurs;
    }
    ...
    //    $statement = $database->prepare($query);
    //    $statement->execute();
    //    $results = $statement->fetchAll(PDO::FETCH_CLASS, "ModelProd");
    //    return $results;
    //   } catch (PDOException $e) {
    //    printf("%s - %s<p/>\n", $e->getCode(), $e->getMessage());
    //    return NULL;
    ...
    public static function getNumber()
    {
        try {
            $database = Model::getInstance();
            $query = "SELECT region, COUNT(DISTINCT id) as nb_producteurs
            FROM producteur
            GROUP BY region;";
            $statement = $database->prepare($query);
            $statement->execute();
    ...
    {
        echo ("ModelProd : update() TODO ....");
        return null;
    }

    public static function delete()
    {
        echo ("ModelProd : delete() TODO ....");
        return null;
    }
}
?>
